...
> **[HAS_TRADES GATE — token-audit 2026-05-18]** Steps 8.96–8.997 รันเฉพาะ **has_trades = TRUE** (มีการเทรดจริงวันนี้)
> - No-trade day / review-only mode → ข้ามทั้ง section 8.96–8.997 → ไปยัง Step 9 โดยตรง
> - ประหยัด ~3,500 tokens ต่อ no-trade day (7 cognitive steps × ~500 tok each)
