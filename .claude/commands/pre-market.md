...
→ **ถ้านับได้ ≥ 2 → confidence = low เสมอ ไม่มีข้อยกเว้น**
→ ถ้านับได้ 1 → ใช้ judgment ปกติ (low/medium)
→ ถ้านับได้ 0 → ใช้ judgment ปกติ (low/medium/high)
*(Lesson จาก 2026-04-28: medium confidence ในวัน FOMC + Mag7 earnings + Iran = over-confident)*
